...
#include<conio.h>
#include<stdio.h>
#include<stdlib.h>		//we have to include Header file <stdlib.h> to use calloc() function
...
void main()
{
	...
	p = (int *)calloc(n,sizeof(int));		//allocates mem dynamically i.e. it will create a mem block array of 'n' blocks whose size will be n*4
